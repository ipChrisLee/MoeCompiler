...
entry:
  %arrayidx = getelementptr inbounds [3 x i32], [3 x i32]* %a, i32 1
  %arrayidx1 = getelementptr inbounds [3 x i32], [3 x i32]* %arrayidx, i32 0, i32 2
  %0 = load i32, i32* %arrayidx1, align 4
  %arrayidx2 = getelementptr inbounds [3 x i32], [3 x i32]* %a, i32 0
  %arrayidx3 = getelementptr inbounds [3 x i32], [3 x i32]* %arrayidx2, i32 0, i32 1
  %1 = load i32, i32* %arrayidx3, align 4
  %add = add nsw i32 %0, %1
  %arrayidx4 = getelementptr inbounds [3 x i32], [3 x i32]* %a, i32 2
